...
// kondrikov_lr3.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Ckondrikovlr3App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &Ckondrikovlr3App::OnAppAbout)
...
// Создание Ckondrikovlr3App

Ckondrikovlr3App::Ckondrikovlr3App() noexcept
{

	// TODO: замените ниже строку идентификатора приложения строкой уникального идентификатора; рекомендуемый
	// формат для строки: ИмяКомпании.ИмяПродукта.СубПродукт.СведенияОВерсии
	SetAppID(_T("kondrikovlr3.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект Ckondrikovlr3App

Ckondrikovlr3App theApp;


// Инициализация Ckondrikovlr3App

BOOL Ckondrikovlr3App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(Ckondrikovlr3Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(Ckondrikovlr3View));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений Ckondrikovlr3App
...
void Ckondrikovlr3App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
